<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="#" class="flex ms-2 md:me-24">
          <img src="{{ asset('build/assets/img/Logo BUKIS.png') }}" class="h-8 me-3" alt="BUKIS Logo" />
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">BUKIS</span>
        </a>
    </div>
    <div class="flex items-center">
        ...
        <div class="flex items-center ms-3 mt-4">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="text-red-600 text-sm font-medium">Keluar</button>
        </form>
        </div>
      </div>
    </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/operator" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
         ...
         <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M13 21V23H11V21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H9C10.1947 3 11.2671 3.52375 12 4.35418C12.7329 3.52375 13.8053 3 15 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H13ZM20 19V5H15C13.8954 5 13 5.89543 13 7V19H20ZM11 19V7C11 5.89543 10.1046 5 9 5H4V19H11Z"></path></svg>
               <span class="flex-1 ms-3 whitespace-nowrap">Input Data Siswa</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
