...
<head>
    ...
    <title>Register Page - Buku Induk Siswa</title>
            ...
            <div class="w-3/4">
                ...
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="name" id="fullname" name="fullname" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                    </div>
                    <!-- Email Input -->
                    <div class="mb-4">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="password" id="confirm-password" name="confirm-password" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500">
                    </div>
                    <!-- Login Button -->
                    <div class="mb-4">
                ...
                <p class="text-sm text-gray-600 text-center">Sudah punya akun? <a href="/login" class="text-blue-500 hover:underline">Login di sini</a></p>
            </div>
        </div>
    </div>
